...
func filterContractRequest(queryString, emptyQueryString string, t *testing.T) {
	...
	if err := sampleOrder().Save(tx, 0).Error; err != nil {
		t.Fatalf(err.Error())
	}
