...
class Order(object):
    ...
    def FromBytes(cls, data):
        ...
        self.takerTokenAmountCancelled = util.bytesToInt(data[409:441])
    ...
    def to_dict(self):
        return {
            ...
            "takerTokenAmountCancelled": str(self.takerTokenAmountCancelled),
            "salt": str(self.salt),
            ...
            "remainingTakerTokenAmount": str(
                self.takerTokenAmount -
                self.takerTokenAmountFilled -
                self.takerTokenAmountCancelled
            )
        }
