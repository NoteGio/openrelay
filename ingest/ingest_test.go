...
func TestBadRead(t *testing.T) {
	...
	handler := mockPoolDecorator(ingest.Handler(&publisher, &TestAccountService{}, &TestAffiliateService{}))
	reader := TestReader{
...
func TestInsufficientFee(t *testing.T) {
	...
	fee := new(big.Int)
	fee.SetInt64(1000)
	handler := mockPoolDecoratorFee(big.NewInt(1000), ingest.Handler(&publisher, &TestAccountService{false, new(big.Int)}, &TestAffiliateService{fee, nil}))
...
func TestBlacklisted(t *testing.T) {
	publisher := TestPublisher{}
	handler := mockPoolDecorator(ingest.Handler(&publisher, &TestAccountService{true, new(big.Int)}, &TestAffiliateService{new(big.Int), nil}))
	data, _ := hex.DecodeString("")
	reader := TestReader{
		data,
		nil,
...
func TestNotFeeRecipient(t *testing.T) {
	publisher := TestPublisher{}
	handler := mockPoolDecorator(ingest.Handler(&publisher, &TestAccountService{true, new(big.Int)}, &TestAffiliateService{nil, errors.New("Fee Recipient must be an authorized address")}))
	data, _ := hex.DecodeString("")
	reader := TestReader{
		data,
		nil,
...
func TestValid(t *testing.T) {
	publisher := TestPublisher{}
	handler := mockPoolDecorator(ingest.Handler(&publisher, &TestAccountService{false, new(big.Int)}, &TestAffiliateService{new(big.Int), nil}))
...
func TestBadExchange(t *testing.T) {
	publisher := TestPublisher{}
	handler := mockPoolDecorator(ingest.Handler(&publisher, &TestAccountService{false, new(big.Int)}, &TestAffiliateService{new(big.Int), nil}))
	data, _ := hex.DecodeString("")
	reader := TestReader{
		data,
		nil,
	}
