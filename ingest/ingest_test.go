...
func TestBadRead(t *testing.T) {
	...
	handler := ingest.Handler(&publisher, &TestAccountService{}, &TestAffiliateService{}, &TestTermsManager{true}, &TestExchangeLookup{true})
	reader := TestReader{
...
func TestInsufficientFee(t *testing.T) {
	...
	fee := new(big.Int)
	fee.SetInt64(1000)
	handler := ingest.Handler(&publisher, &TestAccountService{false, new(big.Int)}, &TestAffiliateService{fee, nil}, &TestTermsManager{true}, &TestExchangeLookup{true})
...
func TestBlacklisted(t *testing.T) {
	publisher := TestPublisher{}
	handler := ingest.Handler(&publisher, &TestAccountService{true, new(big.Int)}, &TestAffiliateService{new(big.Int), nil}, &TestTermsManager{true}, &TestExchangeLookup{true})
	data, _ := hex.DecodeString("")
	reader := TestReader{
		data,
		nil,
...
func TestNotFeeRecipient(t *testing.T) {
	publisher := TestPublisher{}
	handler := ingest.Handler(&publisher, &TestAccountService{true, new(big.Int)}, &TestAffiliateService{nil, errors.New("Fee Recipient must be an authorized address")}, &TestTermsManager{true}, &TestExchangeLookup{true})
	data, _ := hex.DecodeString("")
	reader := TestReader{
		data,
		nil,
...
func TestValid(t *testing.T) {
	publisher := TestPublisher{}
	handler := ingest.Handler(&publisher, &TestAccountService{false, new(big.Int)}, &TestAffiliateService{new(big.Int), nil}, &TestTermsManager{true}, &TestExchangeLookup{true})
	data, _ := hex.DecodeString("")
	reader := TestReader{
		data,
		nil,
...
func TestBadExchange(t *testing.T) {
	publisher := TestPublisher{}
	handler := ingest.Handler(&publisher, &TestAccountService{false, new(big.Int)}, &TestAffiliateService{new(big.Int), nil}, &TestTermsManager{true}, &TestExchangeLookup{false})
	data, _ := hex.DecodeString("")
	reader := TestReader{
		data,
		nil,
...
func TestUnsignedMaker(t *testing.T) {
	publisher := TestPublisher{}
	handler := ingest.Handler(&publisher, &TestAccountService{false, new(big.Int)}, &TestAffiliateService{new(big.Int), nil}, &TestTermsManager{false}, &TestExchangeLookup{true})
	data, _ := hex.DecodeString("")
	reader := TestReader{
		data,
		nil,
