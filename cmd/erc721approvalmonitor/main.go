...
func main() {
	...
	consumer, err := erc721approvals.NewRPCAllowanceBlockConsumer(rpcURL, exchangeAddress, publisher)
	if err != nil {
		log.Fatalf("Error constructing erc720approval monitor: %v", err.Error())
	}
